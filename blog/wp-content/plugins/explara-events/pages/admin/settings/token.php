...
<div class="wrap">
	<div id="account" class="tabcontent">
		...
		<form name="exp_add_form" id="exp_add_form" method="post">
			<div class="bg-wht expwht-wrapper">
				...
				<button type="button" onClick="ExplaraAdminForm.post('#exp_add_form', '<?php echo $reload; ?>')"  class="button button-primary"> Save token </button>
			</form>
		</div>
	</div>
</div>