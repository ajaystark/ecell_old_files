...
$wp_list_table = new explara\AdminGroupsListtable();
$order = "asc";
$orderby = "group_title";
	...
	<div class="exprow">
		<div class="expcol-60">
			<h1 class="wp-heading-inline">
				Groups
				<button id="exp_groups_sync" type="button" class="page-title-action" onClick="ExplaraMembershipAdminForm.fetchSync()">
					Fetch &amp; Sync
				</button>
			</h1>
				...
				<div class="alignright actions new-actions">
					<form method="get" class="search-form">
						<p class="search-box">
							...
							<label class="screen-reader-text"><?php _e('Search Groups', 'tc');?>:</label>
							<input type="text" value="<?php echo isset($_GET['s']) ? $_GET['s'] : '' ?>" name="s">
							<input type="submit" class="button" value="<?php _e('Search Groups', 'tc');?>">
						</p>
					</form>
				</div>
			</div>
