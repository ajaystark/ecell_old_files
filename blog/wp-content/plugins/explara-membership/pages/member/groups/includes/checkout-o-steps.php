<div class="explara_checkout_steps explara_checkout_holder">
	...
	?>
									<tr >
										<td width="20%">
											<label class="">
												<input id="plan_selected_id_value_<?php echo $plan->id; ?>" name="plan<?php echo $plan->id; ?>" onchange="ExplaraMemberCheckout.handelPlanChange('<?php echo $group->db_group->group_id; ?>', '', this, '<?php echo $plan->id; ?>', '<?php echo $currency; ?>')" type="radio" data-set="false" class="explara_member_plan_input" data-id="<?php echo $plan->id; ?>" data-planid="<?php echo $plan->id; ?>" data-mainid="<?php echo $group->db_group->group_id; ?>">
												<?php echo $plan->name; ?>
											</label>
										</td>
										<td width="25%">
		...
		echo 'Free';
										...
										<td width="35%" class="text-right">
											<span class="exp-member-incrementor">
												<span>
													<button type="button" onclick="ExplaraMemberCheckout.decrValue('<?php echo $plan->maxQuantity; ?>', 'plan_selected_<?php echo $plan->id; ?>', '<?php echo $group->db_group->group_id; ?>', '<?php echo $plan->id; ?>', '<?php echo $currency; ?>')"><i class="fa fa-minus" aria-hidden="true"></i>
													</button>
												</span>
												<span>
												...
												<span>
													<button onclick="ExplaraMemberCheckout.incrVal('<?php echo $plan->maxQuantity; ?>', 'plan_selected_<?php echo $plan->id; ?>', '<?php echo $group->db_group->group_id; ?>', '<?php echo $plan->id; ?>', '<?php echo $currency; ?>')" type="button"><i class="fa fa-plus" aria-hidden="true"></i></button>
												</span>
											</span>
										</td>
									</tr>
									...
									<div class="explara_conference_summary exp_event_discount">
										<div class="expl-membership-discount">
											...
											<div class="form-group">
												...
												<button class="search-btn" type="button" onclick="ExplaraMemberCheckout.applyNormalDiscount('<?php echo $group->db_group->group_id; ?>')">Apply</button>
											</div>
										</div>
									</div>
								</div>
		...
		<div id="explara_checkout_plan_attendee_step" class="" style="display:none;">
			<form name="explara_membership_attendee_forms" id="explara_membership_attendee_forms" method="post">
				...
				<div class="md-container-attendee">
