...
add_shortcode('explara-membership-payment', array('explara\ExplaraMembershipPaymentShortcodes', 'payment'));

class ExplaraMembershipPaymentShortcodes {
	...
	private static function getPaymentPage($page) {
		...
		require_once EXPL_MEMBERSHIP_PLUGIN_DIR . '/pages/member/payment/' . $file;
	}
