...
<span class="alignright "> <?php if(is_home() AND !is_paged()) { ?><a href="http://wpdean.com/wiles-wordpress-theme/" >Wiles</a> Theme. <?php }  else { ?>Wiles Theme.<?php  } ?> Powered by <a href="https://wordpress.org/themes/wiles/">WordPress</a>.</span>					
					</p>
                    </div>
                    </div>
